...
public class ControleLogin {
    ...
    public void salvar(ModeloLogin mod){
        ...
        conex.conexao();
        try {
            PreparedStatement pst = conex.conn.prepareStatement("insert into usuario(nome,senha,permissao,login)values(?,?,?,?)");
    ...
    conex.conexao();
        ...
        try {            
            ...
            PreparedStatement pst = conex.conn.prepareStatement("update usuario set nome=?,senha=?,permissao=?,login=? where id_login=?");
    ...
    public void Excluir(ModeloLogin mod){
        conex.conexao();
            try {
                ...
                PreparedStatement pst = conex.conn.prepareStatement("delete from usuario where id_login=?");
    ...
    conex.execultasql("select * from usuario");
        try {
             conex.rs.first();
