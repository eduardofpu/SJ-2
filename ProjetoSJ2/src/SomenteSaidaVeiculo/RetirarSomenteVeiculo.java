 ...
 * @author Eduardo
 */
public class RetirarSomenteVeiculo extends javax.swing.JFrame {
    ...
    jButtonRetirar.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "DoClick");
    jButtonRetirar.getActionMap().put("DoClick", action);
    ...
    private void initComponents() {
        ...
        jButtonRetirar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/back.png"))); // NOI18N
        jButtonRetirar.setText("Retirar");
        jButtonRetirar.setToolTipText("Retirar");
        ...
        jLabel28.setText("Descrição do aluguel");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addComponent(jButtonRetirar, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(22, 22, 22)
                        .addComponent(jLabel28, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabelDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 1046, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(81, 81, 81))
        );
        ...
        jLabel26.setText("Retirar Veículo , mas os moradores ficam.");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jLabelGaragem, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 213, Short.MAX_VALUE)
                .addComponent(jLabel26, javax.swing.GroupLayout.PREFERRED_SIZE, 610, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(278, 278, 278))
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
           ...
           // or garagem ='"+verificaAlugada+"' or garagem='"+verificaOculpada+"'
            conex.execultasql("select * from veiculo where bloco='"+String.valueOf(jComboBoxBloco.getSelectedItem())+"' and numeroApartamento = '"+String.valueOf(jComboBoxApartamento.getSelectedItem())+"' ");
       ...
       jTextFieldPlacaMoto2.setText(conex.rs.getString("placa_moto2"));
        jLabelGaragem.setText(conex.rs.getString("garagem"));
       ...
       jTextAreaBicicleta.setText("");
            ...
            if(jLabelGaragem.getText().equals(verificaAlugada)|| jLabelGaragem.getText().equals(verificaOculpada)){
                      
        JOptionPane.showMessageDialog(rootPane," A garagem encontra-se  "+jLabelGaragem.getText());
            jButtonRetirar.setEnabled(!false);     
            }else{
       ...
       jTextAreaBicicleta.setText("");
                ...
                JOptionPane.showMessageDialog(rootPane," A garagem encontra-se vazia");
                jButtonRetirar.setEnabled(false);
            }
    ...
    private void jButtonRetirarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRetirarActionPerformed
        ...
        if(resposta == 0){  try {
            ...
            PreparedStatement alterarVeiculo = conex.conn.prepareStatement("call retirarsomenteveiculo('"+jTextFieldCodigoVeiculo.getText()+"')");
            
            alterarVeiculo.execute();
            
             JOptionPane.showMessageDialog(rootPane,"Retirado com sucesso");
             dispose();
             
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(rootPane,"Erro ao retirar"+ex);
            }
