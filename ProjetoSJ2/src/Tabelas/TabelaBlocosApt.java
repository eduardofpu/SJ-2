 ...
 * @author Eduardo
 */
public class TabelaBlocosApt extends javax.swing.JFrame {
     int j=1;
    ConectaBanco connn = new ConectaBanco();
    public TabelaBlocosApt() {
        initComponents();
        this.setExtendedState(getExtendedState()| TabelaBlocosApt.MAXIMIZED_BOTH);
...
//faz os botões serem acionados com a tecla enter
    ...
    jButtonBuscarNome.getActionMap().put("DoClick", action);
        ...
        preencherTabelaMoradores("select * from condominio order by bloco");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tabela de Moradores");
        ...
        jLabel2.setText("Buscar : proprietario , morador, situação do imovel e animais");
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        preencherTabelaMoradores("select * from condominio where bloco='"+jComboBoxBlocos.getSelectedItem()+"' and numeroApartamento='"+jComboBoxApts.getSelectedItem()+"'");
    ...
    private void jButtonBuscarNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarNomeActionPerformed
        ...
        preencherTabelaMoradores("select * from condominio where nomeMorador like'%"+jTextFieldNome.getText()+"%' or proprietario like'%"+jTextFieldNome.getText()+"%' or situacaoImovel like'%"+jTextFieldNome.getText()+"%' or observacaoAnimal like'%"+jTextFieldNome.getText()+"%'");
    ...
    public void preencherTabelaMoradores(String sql){
        ...
        String[] Colunas = new String[]{"QT","Bloco","Apartamento","Proprietario","Imóvel","Moradores","Qt animal","Observação"};
        ...
        connn.execultasql(sql);                
            try {
                ...
                do {
                    ...
                    dados.add(new Object[]{j,connn.rs.getString("bloco"),connn.rs.getString("numeroApartamento"),connn.rs.getString("proprietario"),connn.rs.getString("situacaoImovel"),connn.rs.getString("nomeMorador"),connn.rs.getString("quantidadeAnimal"),connn.rs.getString("observacaoAnimal")});
        ...
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
          ...
          jTable1.getColumnModel().getColumn(5).setPreferredWidth(750);
          jTable1.getColumnModel().getColumn(5).setResizable(false); 
          jTable1.getColumnModel().getColumn(6).setPreferredWidth(70);
          jTable1.getColumnModel().getColumn(6).setResizable(false); 
          jTable1.getColumnModel().getColumn(7).setPreferredWidth(750);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaBlocosApt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
