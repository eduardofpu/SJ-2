...
public class TabelaFuncionario extends javax.swing.JFrame {
    ...
    public TabelaFuncionario() {
        initComponents();
        this.setExtendedState(getExtendedState()| TabelaFuncionario.MAXIMIZED_BOTH);
...
//faz os botões serem acionados com a tecla enter
    ...
    public void preencherTabelaFuncionario(String sql){
        ...
        String[] Colunas = new String[]{"Nome","RG","UF","Telefone Próprio","Telefone recado","Contato ","Email","Cidade","Estado","Rua","Numero","Bairro","Complemento"};
        ...
        connn.execultasql(sql);                
            try {
                ...
                do {
                    ...
                    dados.add(new Object[]{connn.rs.getString("nome"),connn.rs.getString("rg"),connn.rs.getString("estadoRg"),connn.rs.getString("telefoneProprio"),connn.rs.getString("telefoneRecado"),connn.rs.getString("nomeContato"),connn.rs.getString("email"),connn.rs.getString("cidade"),connn.rs.getString("estadoCidade"),connn.rs.getString("rua"),connn.rs.getString("numero"),connn.rs.getString("bairro"),connn.rs.getString("complemento")});
