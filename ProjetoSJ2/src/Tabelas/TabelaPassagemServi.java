...
public class TabelaPassagemServi extends javax.swing.JFrame {
    
    ConectaBanco connn = new ConectaBanco();
    public TabelaPassagemServi() {
        initComponents();
        this.setExtendedState(getExtendedState()| TabelaPassagemServi.MAXIMIZED_BOTH);
...
//faz os botões serem acionados com a tecla enter
    ...
    jButtonAtualizar.getActionMap().put("DoClick", action);
       ...
       preencherTabelaPassServ("select * from diario_passagem_servico order by dataObs");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Diário de ocorrências");
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        preencherTabelaPassServ("select * from diario_passagem_servico where nome like'%"+jTextFieldNome.getText()+"%'");
    ...
    public void preencherTabelaPassServ(String sql){
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Data","Hora","nome","Usuário","Observação"};
        ...
        connn.execultasql(sql);                
            try {
                ...
                do {
                    ...
                    dados.add(new Object[]{connn.rs.getString("dataObs"),connn.rs.getString("horaObs"),connn.rs.getString("nome"),connn.rs.getString("usuario"),connn.rs.getString("observacao")});
        ...
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
          ...
          jTable1.getColumnModel().getColumn(4).setPreferredWidth(950);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaPassagemServi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
