 ...
 * @author Eduardo
 */
public class TabelaVeiculosExmorador extends javax.swing.JFrame {
    
    ConectaBanco connn = new ConectaBanco();
    public TabelaVeiculosExmorador() {
        initComponents();
        this.setExtendedState(getExtendedState()| TabelaVeiculosExmorador.MAXIMIZED_BOTH);
...
//faz os botões serem acionados com a tecla enter
    ...
    jButtonBuscarNome.getActionMap().put("DoClick", action);
     ...
     String nome="Vazio";
          ...
          preencherTabelaVeiculos("select * from veiculoexmorador where  motorista_carroAdesivado not like'%"+nome+"%'  and tipo not like'%"+tipoAlterado+"%' order by bloco");
           
       // preencherTabelaVeiculos("select * from veiculoexmorador order by bloco");
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        preencherTabelaVeiculos("select * from veiculoexmorador where bloco='"+jComboBoxBlocos.getSelectedItem()+"' and numeroApartamento='"+jComboBoxApts.getSelectedItem()+"'");
    ...
    public void preencherTabelaVeiculos(String sql){
        ...
        String[] Colunas = new String[]{"Data e Hora da saida","Tipo","Bloco","Apartamento","Modelo-carro-Adesivado","Cor-carro-Adesivado","Motorista-carro-adesivado","CNH-Carro-Adesivado","Placa-carro-Adesivado","Modelo-carro-Não-Adesivado","Cor-carro-Não-Adesivado","Motorista-carro-Não-adesivado","CNH-Carro-Não-Adesivado","Placa-carro-Não-Adesivado","modelo-moto1", "cor-moto1","motorista-moto1","cnh-motorista-moto1","placa-moto1","modelo-moto2", "cor-moto2","motorista-moto2","cnh-motorista-moto2","placa-moto2","Bicicletas" };
...
connn.rs.getString("dataSaida"),connn.rs.getString("tipo"),connn.rs.getString("bloco"),connn.rs.getString("numeroApartamento"),connn.rs.getString("modelo_carroAdesivado"),connn.rs.getString("cor_carroAdesivado"),connn.rs.getString("motorista_carroAdesivado"),connn.rs.getString("cnh_motorista_carroAdesivado"),connn.rs.getString("placa_carroAdesivado"),connn.rs.getString("modelo_carroNaoAdesivado"),connn.rs.getString("cor_carroNaoAdesivado"),connn.rs.getString("motorista_carroNaoAdesivado"),connn.rs.getString("cnh_motorista_carroNaoAdesivado"),connn.rs.getString("placa_carroNaoAdesivado"),connn.rs.getString("modelo_moto1"),connn.rs.getString("cor_moto1"),connn.rs.getString("motorista_moto1"),connn.rs.getString("cnh_motorista_moto1"),connn.rs.getString("placa_moto1"),connn.rs.getString("modelo_moto2"),connn.rs.getString("cor_moto2"),connn.rs.getString("motorista_moto2"),connn.rs.getString("cnh_motorista_moto2"),connn.rs.getString("placa_moto2"),connn.rs.getString("bicicleta")});
        ...
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
          ...
          jTable1.getColumnModel().getColumn(23).setPreferredWidth(170);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaVeiculosExmorador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
