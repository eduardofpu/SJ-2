 ...
 * @author Eduardo
 */
public class TabelaeEXmoradores extends javax.swing.JFrame {
    
    ConectaBanco connn = new ConectaBanco();
    public TabelaeEXmoradores(String bloco,String apt) {
        String blocos=bloco;
        String apartamenotos=apt;
        initComponents();
        this.setExtendedState(getExtendedState()| TabelaeEXmoradores.MAXIMIZED_BOTH);
...
//faz os botões serem acionados com a tecla enter
    ...
    jButtonAtualizar.getActionMap().put("DoClick", action);
          ...
          jComboBoxApt.setSelectedItem(apt);
          
           preencherTabelaEx("select * from exmorador where bloco='"+bloco+"' and numeroApartamento='"+apt+"' and nomeMorador not like'%"+nome+"%'  and tipo not like'%"+tipoAlterado+"%' order by nomeMorador");
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
       ...
       preencherTabelaEx("select * from exmorador where  nomeMorador like '%"+jTextFieldNome.getText()+"%' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaeEXmoradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TabelaeEXmoradores().setVisible(true);
            }
        });
    }
